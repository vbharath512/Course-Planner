...
public class ViewRooms extends javax.swing.JFrame {
	...
	try {
            Map<String,RoomVO>  roomMap = CoursePlanner.roomMap;
            Iterator<RoomVO> iterator = roomMap.values().iterator();
		while(iterator.hasNext()){
                    RoomVO roomVO = iterator.next();
                     s2.addRow(new Object[]{roomVO.getBuilding(), roomVO.getRoomNo(), roomVO.getCapacity()
                });
   ...
   //loaditem();
    ...
    void load1() {
        try {
            ...
            s2.addColumn("Building");
            s2.addColumn("Room Number");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
         ...
         try {
            String roomNumber = jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString() ; 
            int confirmed = JOptionPane.showConfirmDialog(this, "Confirm Delete, Continue ?");
          if(confirmed==0){
            CoursePlanner.roomMap.remove(roomNumber);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
      try{
          String roomNumber = jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString() ;
          ModifyRoom room = new ModifyRoom(roomNumber);
