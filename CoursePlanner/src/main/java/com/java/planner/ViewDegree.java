 ...
 * @author sku263
 */
public class ViewDegree extends javax.swing.JFrame {
	...
	try {
            Map<String,DegreeVO>  degreeMap = CoursePlanner.degreeMap;
            Iterator<DegreeVO> iterator = degreeMap.values().iterator();
		while(iterator.hasNext()){
                    DegreeVO degreeVO = iterator.next();
                     s2.addRow(new Object[]{degreeVO.getDegreeCode(), degreeVO.getDegreeName(), degreeVO.getGradSchool(),
                         degreeVO.getForecast()});
...
private static String FILEPATH = "";
   ...
   //loaditem();
    ...
    int confirmed = JOptionPane.showConfirmDialog(this, "It will remove all existing Degree data, Continue ?");
    if(confirmed==0){
         Map<String,DegreeVO>  degreeMap = CoursePlanner.degreeMap;
            Iterator<String> iterator = degreeMap.keySet().iterator();
            while(iterator.hasNext()){
                 CoursePlanner.degreeMap.remove(iterator.next());
                }
...
{ 
    ...
    degreeVO.setDegreeName((String) jTable1.getValueAt(i, 1));
    degreeVO.setGradSchool((String) jTable1.getValueAt(i, 2));
    degreeVO.setForecast((String) jTable1.getValueAt(i, 3));   
...
JOptionPane.showMessageDialog(this, "Degree Data Saved");
    }
    void load1() {
        try {

            s2.addColumn("Degree Code");
            s2.addColumn("Degree Name");
            s2.addColumn("Grad School");
            s2.addColumn("Forecast");
    ...
    private void initComponents() {
        ...
        jButton8.setText("Delete Degree");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
     ...
     try {
              String degreeCode = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString() ;
              int confirmed = JOptionPane.showConfirmDialog(this, "Confirm Delete, Continue ?");
          if(confirmed==0){
            CoursePlanner.degreeMap.remove(degreeCode);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
      try{
          String degreeCode = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString() ;
          ModifyDegree degree = new ModifyDegree(degreeCode);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDegree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDegree().setVisible(true);
            }
        });
    }
