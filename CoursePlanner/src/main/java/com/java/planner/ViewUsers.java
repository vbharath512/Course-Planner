...
void load1() {
        try {
            ...
            s2.addColumn("UserName");
            s2.addColumn("Password");
            s2.addColumn("Role");
            s2.addColumn("Status");
            s2.addColumn("FullName");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "userName", "password", "role", "status", "fullName"
            }
        ) {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try {
          ...
          if(confirmed==0){
            CoursePlanner.userMap.remove(userName);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
      try{
          String userName = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString() ;
          ModifyUser user = new ModifyUser(userName);
